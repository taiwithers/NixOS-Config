  ...
  xdg.configFile."${config.xdg.configHome}/eww/eww.yuck".text = ''
        ...
        (defwidget bottombar-widget [](
          box :orientation "horizontal"
              ...
              (button :onclick `firefox` :background-image url(/nix/store/0fb2lck2ih5y6hi242ja8wzpvgvhv5im-firefox-unwrapped-125.0.3/lib/firefox/browser/chrome/icons/default/default32.png))
