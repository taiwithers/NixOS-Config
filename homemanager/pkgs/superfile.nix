...
in {
  ...
  xdg.configFile."${spfDir}/config.toml".text = /* TOML */ ''
  ...
  xdg.configFile."${spfDir}/hotkeys.toml".text = /* TOML */ ''
  # =================================================================================================
  ...
  xdg.configFile."${spfDir}/theme/base16.toml".text = with app-themes.palettes.superfile; /* TOML */  ''
