    ...
    },
    {
      ...
      ["keys"] = {
        ...
        },
        {
          "gbc",
          function()
            return vim.api.nvim_get_vvar("count") == 0 and "<Plug>(comment_toggle_blockwise_current)" or
    ...
    },
    {
      ...
      ["after"] = function()
        ...
        vim.keymap.set(
          ...
          {silent = true, noremap = true, desc = "Open lazygit [toggleterm]"}
        )
      end,
      ["cmd"] = {
        "ToggleTerm",
...
local attach_keymaps = function(client, bufnr)
  ...
  vim.keymap.set(
    ...
    {buffer = bufnr, noremap = true, silent = true, desc = "Toggle format on save"}
  )
end
      ...
      "BufWritePre",
      {
        ...
        callback = function()
          ...
          local function is_null_ls_formatting_enabled(bufnr)
            ...
            local generators =
              require("null-ls.generators").get_available(
              file_type,
